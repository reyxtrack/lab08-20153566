...
<div class="container">
 <span>Añadir un rol</span>
    <br />
    <br />
    <span style="font-size: xx-large; font-family: 'Product Sans',Roboto,serif">Add a rol</span>
    <br />
    <br />
    ...
    <form method="post" action="./add">
        ...
        <select name="roleStatus" class="browser-default" required>
            <option value="true" disabled selected>Estado</option>
